...
public class Player extends Sprite{
	...
	public Player(Sprite sprite) {
		...
		x = (Gdx.graphics.getWidth()- Constants.TILE_SIZE*4 )/ 2;
	    y =  (Gdx.graphics.getHeight() - Constants.TILE_SIZE*4) / 2;
	...
	public void setMove() {
		...
		//nie zakładam ruchu "na ukos"	//można nadpisać x i y, ale to jest pardziej przejrzyste
		System.out.println("X_before:\t"+ x);
		...
		destination.x = (int)this.x + tilesX * Constants.TILE_SIZE *4;  //mnoznik
		destination.y = (int)this.y + tilesY * Constants.TILE_SIZE *4;	//mnoznik
...
//t =0.25s -> 128 px speed =16
		...
		x += 16*delta* Constants.TILE_SIZE * tilesX;
		y += 16* delta *Constants.TILE_SIZE * tilesY;
